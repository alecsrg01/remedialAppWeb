...
<body>
    ...
    <nav class="navbar is-danger" role="navigation" aria-label="main navigation">
        <div class="navbar-brand">
            <a class="navbar-item" href="https://classroom.google.com/c/NDQ2MDY0NzEwNDAz/a/NDQ2MDY0NzEwNDU1/details">
                <img alt="" src="./imagenes/descarga.png" style="max-height: 80px" />
            </a>
        ...
        <div class="navbar-menu">
            ...
            <div class="navbar-end">
                ...
                <div class="navbar-item">
                    <div class="buttons">
                        <a target="_blank" rel="noreferrer" href="https://obsproject.com/es/welcome" class="button is-dark">
